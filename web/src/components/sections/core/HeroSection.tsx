  ...
  return (
    <section className="w-full bg-gradient-to-br from-primary/10 via-transparent to-primary/10">
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-1 md:gap-12 items-center">
          ...
          <div className="space-y-6 order-last md:order-1">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
              <Button variant="default" className="cursor-pointer w-full md:w-auto">
