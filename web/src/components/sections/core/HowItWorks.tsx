...
export default function HowItWorks() {
  return (
    <section
      id="how-it-works"
      tabIndex={-1}
      className="w-full bg-[var(--background)] text-[var(--foreground)] py-16 md:py-24 mb-12"
    >
      <style>{`
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
          ...
          <div className="w-full md:w-1/2 order-first md:order-last mb-12">
            ...
            <p className="text-sm md:text-lg text-primary font-medium mb-6 md:mb-12">
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--muted-foreground)]">
                    Make a donation using fiat (Paystack) or crypto (Boom
                    Wallet/Stacks).
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--muted-foreground)]">
                    Our partners and Local Ambassadors procure materials and
                    verify delivery on the ground.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--muted-foreground)]">
                    The verification data is instantly written to Stacks,
                    minting a unique NFT receipt for the donor.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--muted-foreground)]">
                    View the transaction hash and NFT on the Impact-Chain
                    Dashboard to trace your donation from payment to verified
                    delivery.
                  </p>
                </div>
              </div>
            ...
            <div className="relative flex items-center justify-center">
              <div className="rounded-full p-6 md:p-10 border-4 border-[var(--primary)] pulse-soft">
                <img
                  src={BlHowitworksimg}
                  alt="How it works"
                  className="w-48 md:w-80 block rounded-full object-cover"
                />
              </div>
            </div>
          </div>
